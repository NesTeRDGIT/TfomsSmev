...
namespace SMEV.VS.Zags4_0_1
{
    ...
    public class Request_PERNAMEZP : IRequestMessage
    {
        ...
        public static XmlSerializerNamespaces XmlnsClass = new XmlSerializerNamespaces(new[]{ new XmlQualifiedName( "ns2","urn://x-artefacts-zags-pernamezp/root/112-24/4.0.1")});
