...
namespace SMEV.VS.Zags
{
    ...
    public class Request_BRAKZRZP : IRequestMessage
    {
        ...
        public static XmlSerializerNamespaces XmlnsClass = new XmlSerializerNamespaces(new[] { new XmlQualifiedName( "ns2","urn://x-artefacts-zags-brakzrzp/root/112-26/4.0.0") });
    ...
    public class BRAKZRZPResponse : IResponseMessage
    {
        ...
        [XmlAttribute]
        public BRAKZRZPResponseКодОбр КодОбр { get; set; }
